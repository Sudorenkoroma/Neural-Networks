...
Hidden Layers:
Three fully connected layers with ReLU activation and batch normalization.
...
Results
The model achieves competitive accuracy (~98%) on the validation set, demonstrating a solid understanding of neural network construction and optimization.
